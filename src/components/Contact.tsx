...
import { Mail, Phone, MapPin, Globe, ExternalLink, Send, ArrowUpRight } from "lucide-react";
    ...
    <section id="contact" className="py-24 px-6 max-w-7xl mx-auto border-t border-white/5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="p-8 rounded-3xl bg-cardBg border border-white/5 flex flex-col justify-between relative overflow-hidden"
        >
