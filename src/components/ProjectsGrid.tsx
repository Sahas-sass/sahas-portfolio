...
export default function ProjectsGrid() {
  ...
  return (
    <section id="projects" className="py-24 px-6 max-w-7xl mx-auto border-t border-white/5">
      ...
      {/* lg:grid-cols-3 with staggered FadeIn wrappers */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projectsData.map((project, idx) => (
          <FadeIn key={project.id} delay={(idx % 3) * 0.1}>
            <div className="group flex flex-col rounded-3xl bg-cardBg border border-white/5 overflow-hidden hover:border-white/20 transition-all duration-500 relative h-full">
              {/* Subtle Glow */}
